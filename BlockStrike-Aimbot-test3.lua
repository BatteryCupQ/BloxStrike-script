...
-- Антидетект ESP: обводка, HP, скелет + расширение хитбокса + ПРОСТОЙ CFrame АИМ + ВКЛАДКИ + ДИСТАНЦИЯ
...
local aimEnabled = false          -- вкл/выкл (управляется кнопкой)
