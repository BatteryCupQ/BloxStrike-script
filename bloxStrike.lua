-- Антидетект ESP: обводка, HP, скелет + расширение хитбокса + AIM (триггер на голову)
...
-- НАСТРОЙКИ АИМА
local aimSmoothness = 0.3          -- плавность (0.1-0.5)
local aimMethod = "mouse"          -- "mouse" или "camera" (mouse использует mousemoverel, camera - CFrame)
...
-- Новая функция аима (два метода + плавность)
local function aimAtTarget(targetHead)
    ...
    -- Метод 2: прямое изменение камеры
