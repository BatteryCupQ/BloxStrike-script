-- Антидетект ESP: обводка, HP, скелет + расширение хитбокса + AIM (триггер на голову) + ВКЛАДКИ + ДИСТАНЦИЯ + ТРАССЕРЫ + ОРУЖИЕ
...
local function createMenu()
    ...
    mainFrame.Size = UDim2.new(0, 260, 0, 400) -- увеличено для новых кнопок
    ...
    containerFrame.Size = UDim2.new(1, -20, 0, 295) -- увеличено
